...
import {MyDiv, Wrapper, DataForm, Address, Title, 
        MiddleStory, Name, Password, NameOfTitle, Story, 
        AddressContinue, Video, Pictures, UploadPic, AlinePictures,
        FinalButtons, CancelButton, ReviseButton, MainSettings, DataName,
        DataPassword, TitleName, MiddleComment, AddressName, AddressNumber,
        AddressButton, YouTubeVideo, AddingPhoto, MainMenu, MainMenuPicture,
        ButtonLines} 
